...
Sessions are used to authorize a user with the user data staying on the server side

1. What does bcrypt do to help us store passwords in a secure manner.

Bcrypt hashes and seeds the passwords

1. What does bcrypt do to slow down attackers?

Bcrypt loops its hashing function to slow down the brute force approach of hacking
